...
export default async function resultRoutes(fastify) {
    fastify.post('/', { preHandler: [validateRequest(ResultValidation.create)] }, ResultController.createResult);
    fastify.get('/', ResultController.getAllResults);
    fastify.get('/:id', ResultController.getSingleResult);
    fastify.patch('/:id', { preHandler: [validateRequest(ResultValidation.update)] }, ResultController.updateResult);
    fastify.patch('/:id/publish', { preHandler: [validateRequest(ResultValidation.publish)] }, ResultController.publishResult);
