...
const createStudent = catchAsync(async (request, reply) => {
    let body;
    let file;
...
// ── Update Student ─────────────────────────────────────────────────────────
const updateStudent = catchAsync(async (request, reply) => {
...
const getStudentById = catchAsync(async (request, reply) => {
    const { id } = request.params;
...
const getAllStudents = catchAsync(async (request, reply) => {
...
const deleteStudent = catchAsync(async (request, reply) => {
    const { id } = request.params;
