...
const uploadStudentPhoto = async (file) => {
    ...
    if (!ALLOWED_MIME_TYPES.includes(mimetype)) {
        throw new ApiError(httpStatus.BAD_REQUEST, `Invalid file type. Allowed: ${ALLOWED_MIME_TYPES.join(", ")}. Received: ${mimetype}`);
    }
...
const createUserWithStudent = async (payload, file) => {
...
const updateStudent = async (id, payload, file) => {
