...
const updateStudentEnrollment = async (id, payload) => {
...
const promoteStudent = async (payload) => {
 ...
 */
const bulkPromoteStudents = async (payload) => {
    const { sourceAcademicYearId, targetAcademicYearId, targetClassId, targetSectionId, promotions, } = payload;
...
//# sourceMappingURL=studentEnrollment.service.js.map